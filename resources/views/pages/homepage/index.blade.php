...
@section('content')
    <section class="img-shortInfo flex flex-wrap justify-center align-items-center bg-gradient-to-b from-blue-800 to-blue-600 pt-16 pb-28 rounded-b-[30%] md:rounded-b-[45%] lg:rounded-b-[60%]">
        ...
        <div class="imgInfo border border-black w-52 h-52 md:scale-125 rounded-lg relative group m-5">
            <div class="btnNext-back">
                <div onclick="previousSlide()" class="btnBackImg absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1 py-3 opacity-0 hover:-translate-x-3/4 hover:opacity-100 hover:cursor-pointer rounded-md hover:bg-white/50 transition-all">
                    <i class="bi bi-chevron-compact-left text-4xl" ></i>
                </div>
                <div onclick="nextSlide()" class="btnNextImg absolute right-0 top-1/2 -translate-y-1/2 translate-x-1 py-3 opacity-0 hover:translate-x-3/4 hover:opacity-100 hover:cursor-pointer rounded-md hover:bg-white/50 transition-all">
                    <i class="bi bi-chevron-compact-right text-4xl" ></i>
                </div>
            </div>
            <div class="listImg">
                <img src="assets/img/main/126465066756.jpg" alt="img1" class="object-cover object-center aspect-square rounded-lg text-center items-center">
                <img src="assets/img/main/example-image2.png" alt="img1" class="object-cover object-center aspect-square rounded-lg text-center items-center hidden">
                <img src="assets/img/main/example-image.jpg" alt="img2" class="object-cover object-center aspect-square rounded-lg text-center items-center hidden">
                <img src="assets/img/main/vecteezy_abstract-black-and-white-pattern-like-psychedelic_.jpg" alt="img3" class="object-cover object-center aspect-square rounded-lg text-center items-center hidden">
                <img src="assets/img/icon/add-b.png" alt="img4" class="object-cover object-center aspect-square rounded-lg text-center items-center hidden">
            </div>
        </div>
    </section>
    ...
    <section class="principle mt-32 flex flex-wrap justify-center align-items-center gap-[75px]">
        ...
        <div class="quote-principle align-self-center self-center p-4 w-[600px] h-[400px] lg:w-[800px] lg:h-[600px] shadow-xl rounded-xl relative ">
            ...
            <div class="quote mt-24 lg:mt-32 self-center w-3/4 h-1/2 mx-auto text-base lg:text-lg border-2 border-dashed border-black/40 p-4 rounded-2xl">
    ...
    <section class="statisticSchool bg-[#0000FF] text-white uppercase p-8 py-12">
        ...
        <div class="listStatistics mt-8 flex flex-col md:flex-row justify-center align-items-center gap-20 md:gap-28 sm:flex-wrap">
    ...
    <section class="galHomepage">
        ...
        <div class="descGaleri text-center mt-8">
            <p class="text-[#727272] text-base w-1/2 mx-auto">
                Koleksi foto yang mengabadikan berbagai momen dan aktivitas di sekolah kami, dari prestasi akademik hingga kegiatan OSIS. Mari menjelajahi kenangan-kenangan berharga di sini.
            </p>
        </div>
        <div class="galAct-Insfra">
            <div class="chooseSHAct-Insfra relative mt-5 flex items-center justify-center gap-6 after:absolute after:-bottom-1.5 after:left-1/2 after:-translate-x-1/2 after:translate-y-1.5 after:border-b-2 after:border-[#0066FF] after:w-1/3 after:h-auto">
                <button type="button" class="galAct bg-transparent px-12 py-2 rounded-xl hover:bg-gray-400/[15%]">
                    <div class="titleAct inline-flex items-center gap-3 text-xl">
                        <img src="assets/img/icon/icon baloon chats.svg" alt="" class="w-[50px]">
                        Kegiatan
                    </div>
                </button>
                <button type="button" class="galInsfra bg-transparent px-12 py-2 rounded-xl hover:bg-gray-400/[15%]">
            ...
            <div class="contentAct-Insfra mt-7 px-12">
                <div class="contentAct flex flex-wrap justify-center align-items-center border border-black">
                    <div class="descAct w-1/3 border border-black">
                        <h2 class="text-xl font-bold">Beragam kegiatan menarik yang telah kami dokumentasikan selama di SMPN Kami</h2>
                        <p class="mt-6 mb-4">Kami ingin berbagi momen-momen berharga ini. Dari olahraga hingga seni, mari jelajahi serunya masa SMP!</p>
                        <a href="" class="text-xs text-white font-bold bg-[#0033CC] px-8 py-4 rounded-lg">Selengkapnya</a>
                    </div>
                    <div class="exampleImageAct flex w-1/2 border border-black">
                        <div class="imgAct1">
                            <img src="assets/img/dumb/imgtemp 1.jpg" alt="" class="w-20">
                        </div>
                        <div class="imgAct2">
                            <img src="assets/img/dumb/imgtemp 2.jpg" alt="" class="w-20">
                        </div>
                        <div class="imgAct3">
                            <img src="assets/img/dumb/imgtemp 3.jpg" alt="" class="w-20">
                        </div>
                    </div>
                </div>
                <div class="contentInsfra flex flex-wrap justify-center align-items-center border border-black">
                    <div class="descInsfra w-1/3 border border-black">
                        <h2 class="text-xl font-bold">Fasilitas yang Tersedia di SMP Kami</h2>
                        <p class="mt-6 mb-4">Berikut adalah fasilitas yang disediakan sekolah untuk menunjang kegiatan belajar mengajar di sekolah guna mendapat hasil yang maskimal</p>
                        <a href="" class="text-xs text-white font-bold bg-[#0033CC] px-8 py-4 rounded-lg">Selengkapnya</a>
                    </div>
                    <div class="exampleImageInsfra flex w-1/2 border border-black">
                        <div class="imgInsfra1">
                            <img src="assets/img/dumb/imgtemp 1.jpg" alt="" class="w-20">
                        </div>
                        <div class="imgInsfra2">
                            <img src="assets/img/dumb/imgtemp 2.jpg" alt="" class="w-20">
                        </div>
                        <div class="imgInsfra3">
                            <img src="assets/img/dumb/imgtemp 3.jpg" alt="" class="w-20">
                        </div>
                    </div>
                </div>
