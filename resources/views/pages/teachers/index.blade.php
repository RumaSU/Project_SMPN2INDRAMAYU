...
@section('content')
    ...
    <section class="frmAddTeachers mt-12">
        <div class="title-teachers text-2xl flex items-center px-6 md:px-12 gap-6 py-4 font-bold border-b-4 border-black relative">
            ...
            @endif
            <span role="button" class="btrcr-fm lg:text-3xl py-2 px-4 lg:px-6 flex items-center" onclick="opnFormTeDats()">
                <i class="bi bi-plus-circle md:mr-2 text-2xl"></i>
                <p class="hidden md:block">Pendidik</p>
            </span>
        </div>
    </section>
                            ...
                            <div class="abtSumEks mt-4">
                                <div class="cntnAbtSumEks text-white overflow-hidden">
                                    <div class="imgWthNameTeDats flex flex-col items-center gap-4">
                                        ...
                                        <div class="nmeTeWthEdDel w-full space-y-2">
                                            <div class="nmeTeWthNip" role="">
                                                <div class="nmeTe">
                                                    <div class="thLabels">
                                                        <label for="EditNameTeacher">Nama</label>
                                                    </div>
                                                    <input type="text" name="nameTeachers" id="EditNameTeacher" class="text-black w-full py-1 px-4 outline-none rounded-sm">
                                                </div>
                                                <div class="nipTe">
                                                    <div class="thLabels">
                                                        <label for="EditNIPTeacher">Nip</label>
                                                    </div>
                                                    <input type="text" name="nipTeachers" id="EditNIPTeacher" class="text-black w-full py-1 px-4 outline-none rounded-sm">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    {{-- <div class="cntnEks mt-4">
                                        <div class="descTe">
                                            <div class="thLabels">
                                                <label for="EditDescriptionTeacher">Deskripsi</label>
                                            </div>
                                            <textarea type="text" name="nipTeacher" id="EditDescriptionTeacher" class="w-full h-auto min-h-[12rem] max-h-[24rem] py-1 px-4 rounded-lg resize-none overflow-hidden text-black" oninput="autoResize(this)"></textarea>
                                        </div>
                                    </div> --}}
                                </div>
                            </div>
