...
@section('content')
    ...
    <section class="mt-20">
        <div class="strOrg px-24 flex flex-col lg:flex-row items-center">
            <div class="chrt-fTeSt border border-black mt-12 w-1/2">
                <div class="titleSct">
                    <div class="tSct w-fit py-3 px-6 bg-blue-400 rounded-xl text-white font-bold">
                        <p>Struktur Organisasi</p>
                    </div>
                </div>
                <div class="chrtImg border border-black p-4">
            ...
            <div class="fTeStImg border border-black p-4 w-1/2">
    ...
    <section class="mt-24 bg-gray-200 p-20">
        <div class="mgSch">
            ...
            <div class="liMgSch mt-12 border border-black relative p-6">
                <div class="swpItmMg flex justify-between absolute space-x-6">
