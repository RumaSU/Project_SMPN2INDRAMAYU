...
@section('content')
    <section class="img-students flex items-center justify-center relative text-center text-white h-96 bg-cover bg-center bg-no-repeat after:absolute after:top-0 after:left-0 after:bg-black/60 after:w-full after:h-full"
        ...
        <div class="content relative z-10 selft-center">
            <h1 class="text-4xl font-bold">Daftar Siswa</h1>
    ...
    <section class="listStudents mt-12 px-12 py-20 space-y-12">
        <div class="list">
            ...
            <div class="list-items mt-6 flex flex-wrap gap-5">
                <div class="group bg-white regular-shadow w-48 h-64 border rounded-2xl overflow-hidden relative">
                    <div class="button-editDel flex absolute bg-black/40 py-1 px-4 rounded-xl z-10 -right-full top-[5%] -translate-x-[5%] translate-y-full transition-all group-hover:right-[5%] group-hover:translate-x-[5%] group-hover:top-[5%] group-hover:translate-y-[5%]">
                        <div class="editB border border-black bg-white p-2 rounded-lg hover:bg-gray-200">
                            <i class="bi bi-pencil"></i>
                        </div>
                        <div class="delB border border-black bg-white p-2 rounded-lg hover:bg-gray-200">
                            <i class="bi bi-trash3"></i>
                        </div>
                        <div class="shSocmed border border-black bg-white p-2 rounded-lg hover:bg-gray-200">
