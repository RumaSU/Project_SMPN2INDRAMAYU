...
@section('content')
    ...
    <section class="mt-24">
        <div class="tiType-gal lg:w-3/4 p-4 py-4 lg:py-10 mx-auto bg-gray-100 2xl:rounded-xl">
            <div class="type-gal flex justify-center items-center h-full lg:gap-6 select-none">
                <span role="button" id="idIt1-chsAct" class="itemShowSection it1-chsAct cursor-default lg:w-72 p-3 rounded-lg transition-colors @if (Request::is('galeri/kegiatan')) bg-blue-500 text-white @else hover:bg-gray-300/60 @endif">
    ...
    <section class="sectionGalery" id="secGalAct">
